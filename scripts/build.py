...
<meta name="description" content="DevOps Cheatsheet — a searchable, self-hosted command reference — Linux, Kubernetes, databases, monitoring, and more, with hover explanations and per-topic troubleshooting.">
<meta name="theme-color" content="#08090C">
<meta property="og:title" content="{title} — DevOps Cheatsheet">
<meta property="og:description" content="A searchable, self-hosted DevOps command reference with hover explanations and per-topic troubleshooting.">
<meta property="og:type" content="website">
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%2308090C%22/%3E%3Cpath%20d%3D%22M4%204%20L4%2013%20M4%204%20L13%204%22%20stroke%3D%22%23FF6A1A%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%3Cpath%20d%3D%22M28%2028%20L28%2019%20M28%2028%20L19%2028%22%20stroke%3D%22%23FF6A1A%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%3C/svg%3E">
...
<script src="{prefix}assets/copy.js"></script>
</body>
</html>
"""
    ...
    def repl_code(m):
        ...
        for group in groups:
            ...
            if tip:
                ...
                short_comment = comment.strip().split(' — ', 1)[0].strip()
                comment_esc = html.escape(short_comment)
                boxes.append(
                    f'<div class="cmd-box"><span class="c">{marker} {comment_esc}</span>'
                    f'<span class="cmdline" tabindex="0" data-tip="{tip_esc}">{cmd_full}</span>'
                    f'<button class="copy-btn" type="button">copy</button></div>'
                )
            else:
                boxes.append(f'<div class="cmd-box"><span class="cmdline">{cmd_full}</span><button class="copy-btn" type="button">copy</button></div>')
...
<meta name="description" content="DevOps Cheatsheet — a searchable, self-hosted command reference — Linux, Kubernetes, databases, monitoring, and more, with hover explanations and per-topic troubleshooting.">
<meta name="theme-color" content="#08090C">
<meta property="og:title" content="DevOps Cheatsheet">
<meta property="og:description" content="A searchable, self-hosted DevOps command reference — Linux, Kubernetes, databases, monitoring, and more.">
<meta property="og:type" content="website">
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%2308090C%22/%3E%3Cpath%20d%3D%22M4%204%20L4%2013%20M4%204%20L13%204%22%20stroke%3D%22%23FF6A1A%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%3Cpath%20d%3D%22M28%2028%20L28%2019%20M28%2028%20L19%2028%22%20stroke%3D%22%23FF6A1A%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%3C/svg%3E">
...
<div style="max-width:1100px;margin:0 auto;padding:40px 36px 80px;">
  ...
  {''.join(group_html)}
  <div class="build-stamp">BUILD {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}</div>
</div>
