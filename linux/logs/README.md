...
awk '/2026-09-10 14:0/,/2026-09-10 14:1/' app.log             # print only lines within a time window, useful on huge logs where grep -A/-B isn't precise enough
journalctl --since "10 minutes ago" -o cat                      # even for app logs, check whether the app is actually logging to the journal instead of a file
